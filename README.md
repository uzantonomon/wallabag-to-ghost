...
* Get the necessary secrets:
  * **Wallabag** (replace with your URL):
    * Follow the instructions here: https://wallabag.example.com/developer/howto/first-app
  * **Ghost**:
    * Follow the instructions here: https://ghost.org/docs/api/v3/admin/#token-authentication
    * The ID of the page you want to update (check the URL when opening the page on the Ghost editor): https://ghost.example.com/ghost/#/editor/page/your-page-id
...
GHOST_AUTH = "your-ghost-api-key-id"
